...
- **Đặc điểm chính**:
    ...
    - **Tentacle Grab**: Sử dụng xúc tu để giữ người chơi, khiến họ không thể di chuyển.
...
- **Đặc điểm chính**:
    ...
    - **Web Trap**: Giăng mạng nhện làm giảm tốc độ di chuyển của người chơi.
